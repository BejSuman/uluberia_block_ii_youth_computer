            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <p>In the history of modern astronomy, there is probably no one greater leap forward than the building
                        and launch of the space telescope known as the Hubble.</p>
        ...
        <div class="container">
            ...
            <div class="row team_inner">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="rounded-circle" src={{ asset('assets/img/team/team-2.jpg') }} alt="">
                            <div class="hover">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-linkedin"></i></a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="rounded-circle" src={{ asset('assets/img/team/team-4.jpg') }} alt="">
                            <div class="hover">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                                <a href="#"><i class="fa fa-linkedin"></i></a>
            ...
            <div class="row latest_blog_inner">
                <div class="col-lg-3 col-md-6">
                    <div class="l_blog_item">
                        <img class="img-fluid" src={{ asset('assets/img/latest-blog/l-blog-1.jpg') }} alt="">
                        ...
                        <p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend
                            hours in front of their desktops, while delivery</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="l_blog_item">
                        <img class="img-fluid" src={{ asset('assets/img/latest-blog/l-blog-2.jpg') }} alt="">
                        <a class="date" href="#">25 October, 2018 | By Mark Wiens</a>
                        <a href="single-blog.html">
                            <h4>Addiction When Gambling Becomes A Problem</h4>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="l_blog_item">
                        <img class="img-fluid" src={{ asset('assets/img/latest-blog/l-blog-3.jpg') }} alt="">
                        <a class="date" href="#">25 October, 2018 | By Mark Wiens</a>
                        <a href="single-blog.html">
                            <h4>Addiction When Gambling Becomes A Problem</h4>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="l_blog_item">
                        <img class="img-fluid" src={{ asset('assets/img/latest-blog/l-blog-4.jpg') }} alt="">
                        <a class="date" href="#">25 October, 2018 | By Mark Wiens</a>
                        <a href="single-blog.html">
                            <h4>Addiction When Gambling Becomes A Problem</h4>
                        </a>
